...
import { Avatar, Button, Divider, Form, Input, Modal, Space, Typography, message } from "antd";
    ...
    >
      {!user ? (
        ...
        <Space direction="vertical" size={16} style={{ width: "100%" }}>
          ...
          <Text strong>{vi.profile.passwordSection}</Text>
          <Form form={passwordForm} layout="vertical" requiredMark={false}>
            ...
            <Button onClick={() => void submitPassword()} loading={passwordSaving}>
