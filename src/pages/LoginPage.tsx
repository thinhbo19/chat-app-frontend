      ...
      <div className="animate-auth-card-in relative z-10 w-full max-w-[420px]">
        <div className="rounded-2xl border border-white/70 bg-white/75 p-8 shadow-xl shadow-sky-900/10 ring-1 ring-sky-100/80 backdrop-blur-xl sm:p-9">
          <header className="mb-8 text-center">
            <div
              className="animate-auth-float mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-sky-400 to-blue-600 text-3xl text-white shadow-lg shadow-sky-500/30 ring-1 ring-white/50"
              aria-hidden
            >
              💬
            </div>
